...
The official pylon ROS2 driver for [Basler](http://www.baslerweb.com/) GigE Vision, Basler USB3 Vision and Basler blaze 3D cameras (Galactic Geochelone) 
...
- From [pylon Camera Software Suite](https://www2.baslerweb.com/en/downloads/software-downloads/) version 6.2 or newer. The latest APi libraries must be installed manually. Download and install the latest pylon Camera Software Suite Linux Debian Installer Package for your architecture.
...
``cd ~/dev_ws/src && git clone -b galactic https://github.com/basler/pylon-ros-camera pylon_ros2_camera``  
